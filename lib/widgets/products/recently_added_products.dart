...
class RecentlyAddedProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<QuerySnapshot>(
      future: _services.products.where('published' , isEqualTo: true).where('collection' ,isEqualTo: 'Recently Added').where('seller.sellerUid', isEqualTo: _store.storedetails['uid']).get(),
